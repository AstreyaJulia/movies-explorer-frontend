    ...
    <div className={classNames('navigation__burger-menu', props.class || '')}>
      ...
      >
        <svg className='navigation__burger-button-icon' width='44px' height='44px' viewBox="0 0 44 44"
          ...
          <line x1="8" y1="12.5" x2="36" y2="12.5" stroke='#000000' strokeWidth="3"/>
          <line x1="8" y1="22.5" x2="36" y2="22.5" stroke='#000000' strokeWidth="3"/>
          <line x1="8" y1="32.5" x2="36" y2="32.5" stroke='#000000' strokeWidth="3"/>
        </svg>
      </button>
      {burgerMenuShown ?
        <>
          ...
          <div className='navigation__burger-container'>
            ...
            <div className='navigation__burger-nav'>
              <div className='navigation__burger-nav_top'>
                <LinkCustom
                  class={classNames('navigation-menu__link', props.saved || props.profile ? '' : 'navigation-menu__link_active')}
                  type='route'
                  to='/movies'
                  text='Фильмы'
                />
                <LinkCustom
                  class={classNames('navigation-menu__link', props.saved ? 'navigation-menu__link_active' : '')}
                  type='route'
                  to='/saved-movies'
                  text='Сохраненные фильмы'
                />
              </div>
              <div className='navigation__burger-nav_bottom'>
                <LinkCustom
