...
const Main = () => {
  ...
  return (
    <>
      <Header type='main'>
        {currentUser.name ?
          /* Навигация для авт. пользователя */
          <Navigation class='main__navigation'>
            {/* Десктопная навигация */}
            <Navigation.Desktop class='main__navigation-menu main__navigation-menu_desktop'>
              <LinkCustom
            ...
            {/* Мобильная навигация*/}
            <Navigation.Mobile class='main__navigation-menu main__navigation-menu_mobile'>
              <BurgerMenu page='main' main/>
            </Navigation.Mobile>
          </Navigation>
          :
